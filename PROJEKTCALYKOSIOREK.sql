...
(id_nagrody, kategoria_nagrody, nomianacja_nagrody, wynik_nagrody, rok_nagrody)
VALUES
(2, 'Latin Music Awards – zespół i płyta roku','Empezar Desde Cero' , 'WYGRANA', 2007);
...
(id_nagrody, kategoria_nagrody, nomianacja_nagrody, wynik_nagrody, rok_nagrody)
VALUES
(19, '  Nagroda Super Jedynek Zespól :','Dziewczyny z byle kim nie tańczą' , 'NOMINACJA', 2016);
...
(id_nagrody, kategoria_nagrody, nomianacja_nagrody, wynik_nagrody, rok_nagrody)
VALUES
(23, 'Fryderyki : Album roku -rock','Nic nie boli tak jak życie' , 'NOMINACJA', 1997);
...
(id_nagrody, kategoria_nagrody, nomianacja_nagrody, wynik_nagrody, rok_nagrody)
VALUES
(26, 'TVyNovelas Award for Best Young Lead Actress ','Nie igraj z Aniołem' , 'WYGRANA', 2009);

INSERT INTO Nagrody
(id_nagrody, kategoria_nagrody, nomianacja_nagrody, wynik_nagrody, rok_nagrody)
VALUES
(27, 'Nagroda Grammy: Najlepsze męskie wokalne wykonanie  ','Double Fantasy' , 'WYGRANA', 1982);
...
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(3,1,5,4,'Louis Daniel','Armstrong', '04-Aug-1901','trębacz , wokalista');
...
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(6,6,14,2,' Enrique Martín','Morales', '19-Dec-1971','wokalista i aktor znany jako Ricki Martin');
...
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(8,3,16,2,' Edward Christopher','Sheeran', '17-Feb-1991','piosenkarz, autor tekstów i producent');


INSERT INTO Osoba
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(9,7,17,1,'Avril Ramona','Lavigne', '27-Sep-1984','piosenkarka, gitarzystka, autorka tekstów, kompozytorka');
...
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(10,8,18,6,'David','Bisbal Ferré', '05-Jun-1979','piosenkarz, autor tekstów i aktor');
...
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(12,11,22,1,'Andrzej','Mogielnicki', '15-Dec-1948','autor tekstów piosenek, członek Akademii Fonograficznej ');

INSERT INTO Osoba
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(13,3,24,11,'John Frederick','Porter', '15-Aug-1950','muzyk, kompozytor i tekściarz ');

INSERT INTO Osoba
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(14,2,25,6,'Dulce María','Espinosa Saviñón', '06-Dec-1985','piosenkarka, autorka tekstów i aktorka');

INSERT INTO Osoba
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(15,2,26,6,'Maite','Perroni Beorlegui', '09-Mar-1983','piosenkarka, autorka tekstów i aktorka');

INSERT INTO Osoba
(id_osoby, id_kraju, id_nagrody, id_gatunek,imie_osoby, nazwisko_osoby, data_urodzenia, opis)
VALUES
(16,3,27,1,'John Winston Ono','Lennon', '08-Dec-1980',' muzyk, kompozytor, piosenkarz i autor tekstów');
...
(id_plyta,  id_plyta_rodzaj,  id_gatunek, nazwa_plyty,  rok_nagrania, ilosc_nosnikow,indeks,dystrybutor)
VALUES
(3,1,1,'Złota kolekcja: Kocham cię kochanie moje / Raz-dwa, raz-dwa',2008,2,65313671,'Warner Music Poland');
...
(id_plyta,  id_plyta_rodzaj,  id_gatunek, nazwa_plyty,  rok_nagrania, ilosc_nosnikow,indeks,dystrybutor)
VALUES
(7,1,4,'The Essential Louis Armstrong',1970,1,67996148,'CD-Contact Grzegorz Jasiński');
